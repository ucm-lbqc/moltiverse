...
module Namdconf
    ...
    def enhanced_sampling(explicit_water : Bool, system : String, topology_file : String, coordinates_file : String, output_file : String, time_rmsd : Float32, time_rdgyr : Float32, window : String, type : String)
        if explicit_water
